...
const styles = {
  ...
  companyPillRow: { display: 'flex', gap: '0.6rem', overflowX: 'auto', paddingBottom: '0.4rem', scrollbarWidth: 'none' },
  companyPill: {
    padding: '0.4rem 1rem',
    borderRadius: '20px',
    background: 'rgba(255, 255, 255, 0.05)',
  ...
  searchIcon: { position: 'absolute', left: '0.9rem', top: '12px', color: '#94a3b8' },
  ...
  alumName: { fontSize: '1.05rem', fontWeight: '700', color: '#f8fafc', margin: 0 },
  alumRole: { fontSize: '0.83rem', color: '#94a3b8', fontWeight: '500', marginTop: '0.1rem' },
  companyBadge: {
    display: 'inline-flex',
    alignItems: 'center',
    gap: '0.35rem',
  ...
  alumCardBody: { display: 'flex', flexDirection: 'column', gap: '0.75rem', borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: '0.75rem' },
  metaRow: { display: 'flex', gap: '1rem', fontSize: '0.78rem', color: '#94a3b8' },
  metaItem: { display: 'flex', alignItems: 'center', gap: '0.35rem' },
  alumBio: { fontSize: '0.82rem', color: '#cbd5e1', fontStyle: 'italic', margin: 0, lineHeight: '1.45' },
  ...
  alumCardFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: '0.85rem', gap: '0.5rem' },
  iconBtn: {
    width: '34px',
    height: '34px',
    padding: 0,
